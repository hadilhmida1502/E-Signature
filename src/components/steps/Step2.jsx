        ...
        <div className='main-table'>
            ...
            <div className="container-fluid">
                <div className='row'>
                    ...
                    <a  href="/step1" class="btn btn-secondary m-1 mt-5 float-end">&laquo; Previous</a>&nbsp;&nbsp;&nbsp;
                    <a  href="/step3"><button  onClick={handleNext} class="btn btn-success m-1 mt-5 float-end">Next &raquo;</button></a>
                    </div>
                </div>
            </div>
            <br /><br /><br />
